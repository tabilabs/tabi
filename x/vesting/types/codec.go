...
const (
	// Amino names
	clawback                     = "tabi/MsgClawback"
	createClawbackVestingAccount = "tabi/MsgCreateClawbackVestingAccount"
	updateVestingFunder          = "tabi/MsgUpdateVestingFunder"
	convertVestingAccount        = "tabi/MsgConvertVestingAccount"
)
