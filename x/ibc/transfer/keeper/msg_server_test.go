...
import (
	...
	"github.com/tabilabs/tabi/x/ibc/transfer/keeper"
)
	...
	testCases := []struct {
	...
	}{
		{
			...
			func() *types.MsgTransfer {
				...
				transferMsg := types.NewMsgTransfer("transfer", "channel-0", sdk.NewCoin("atabi", sdk.NewInt(10)), senderAcc.String(), "", timeoutHeight, 0, "")
