...
const (
	// Amino names
	cancelRevenueName   = "tabi/MsgCancelRevenue"
	registerRevenueName = "tabi/MsgRegisterRevenue"
	updateRevenueName   = "tabi/MsgUpdateRevenue"
	updateParamsName    = "tabi/MsgUpdateParams"
)
