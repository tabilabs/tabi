...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "tabi_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "TABI_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Tabi_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "tabi_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "tabi_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "tabi_tabi_9789-1", true, nil,
		},
		{
			"invalid epoch, undefined", "tabi_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "tabi_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}
