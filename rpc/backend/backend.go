...
type EVMBackend interface {
	...
	GetTxByEthHash(txHash common.Hash) (*tabitypes.TxResult, error)
	GetTxByTxIndex(height int64, txIndex uint) (*tabitypes.TxResult, error)
...
func NewBackend(
	...
	chainID, err := tabitypes.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
