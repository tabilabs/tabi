...
# Initialize chain.
tabid init test --chain-id tabi_9789-2

# Get Genesis
wget https://archive.tabi.org/mainnet/genesis.json
mv genesis.json ~/.tabid/config/

wget -O ~/.tabid/config/adrbook.json https://snapshot.notional.ventures/tabi/addrbook.json
...
export TABID_P2P_MAX_NUM_INBOUND_PEERS=200
export TABID_P2P_MAX_NUM_OUTBOUND_PEERS=200
export TABID_STATESYNC_RPC_SERVERS="https://tabi-rpc.polkachu.com:443,https://rpc-tabi-ia.notional.ventures:443"
